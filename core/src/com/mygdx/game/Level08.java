...
public class Level08 extends MyScreenBeta {
    @Override
    public void EnemiesInit() {
        levelNum = 8; // define the current level
        waveNum = 4;
        ...
        medBoatNums = new int[]{3,1,1,4};//{2,2,3,3,3};
        bigBoatNums = new int[]{0,0,0,0};//{0,0,1,1,2};
        ...
        CreateBoatMedium(9); // sum of all elements in the medBoatNums array
        CreateBoatBig(0); // sum of all elements in the bigBoatNums array
