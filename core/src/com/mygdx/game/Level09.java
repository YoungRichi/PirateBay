...
public class Level09 extends MyScreenBeta {

    @Override
    public void EnemiesInit() {
        levelNum = 9; // define the current level
        waveNum = 4;
        ...
        smallBoatNums = new int[] {4,4,0,0};//{1,1,2,2,2}; // value of each element is the number of the object each wave
        medBoatNums = new int[]{0,1,1,4};//{2,2,3,3,3};
        bigBoatNums = new int[]{0,0,1,2};//{0,0,1,1,2};
        ...
        CreateBoatBig(3); // sum of all elements in the bigBoatNums array
